...
{
    public partial class ButterTab : UserControl
    {
        public ButterFilter ceb1fil;

        private int validFg;

        public ButterTab(FilterProperty fs, AbstractFilter fil)
        {
            InitializeComponent();
            validFg = 0;

            this.ceb1fil = (ButterFilter)fil;
