...
{
    public partial class Cheby1Tab : UserControl
    {
        public Cheb1Filter ceb1fil;
        NumberFormatInfo provider = new NumberFormatInfo();
                
        private int validFg;

        public Cheby1Tab(FilterProperty fs, AbstractFilter fil)
        {
            InitializeComponent();
            validFg = 0;
            provider.NumberDecimalSeparator = ".";
            this.ceb1fil = (Cheb1Filter)fil;
            textBox1.Text = ceb1fil.Order.ToString();
            textBox2.Text = ceb1fil.R.ToString(provider);
